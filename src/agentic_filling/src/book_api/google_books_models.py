...
class ImageLinks(BaseModel):
    small_thumbnail: Optional[str] = Field(
        None, alias="smallThumbnail", description="URL for the small thumbnail image of the book cover."
    )
    thumbnail: Optional[str] = Field(
        None, alias="thumbnail", description="URL for the standard thumbnail image of the book cover."
    )
...
class GoogleBooksResponse(BaseModel):
    ...
    self_link: str = Field(..., alias="selfLink", description="API link for the item resource.")
    volume_info: VolumeInfo = Field(
        ..., alias="volumeInfo", description="Metadata and descriptive info about the volume."
    )
